...
<html>
  ...
  <body id='fullscreen'>
    ...
    <div id='container'>
      <section class='amp-bg fixed' src='<?= absolute_path(get(json('meta'), 'amplugged-bg')) ?>'></section>
      <section>
        <div id='amplugged' class='wrapper'>
          <div id='amplugged-top'>
            ...
            <div id='amplugged-description'>
              <div class='heading'>
                <img src='<?= absolute_path('images/icons/amplugged.jpg') ?>' alt='AMPlugged Sessions'>
              </div>
