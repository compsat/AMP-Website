...
<html>
  ...
  <body id='fullscreen'>
    <section class='fixed amp-bg' src='<?= relative_path(get($meta, 'about-bg')) ?>'></section>
    ...
    <div id='container'>
      ...
      <section id='description'>
        <div class='about'>
          <div class='wrapper'>
            <div class='wrapper'>
              <h1><?= relative_path(get($meta, 'about-heading', 'We Are Amp.')) ?></h1>
              <?= paragraph(get($meta, 'about-description')) ?>
            </div>
          </div>
      ...
      <section class='transition' id='executive-board'>
        ...
        <img src='<?= relative_path($meta['eb group photo']) ?>'>
      </section>
      <section class='feature'>
        <div class='feature-labels'><?php
          ...
          foreach ($eb as &$executive) { ?>
            <div index=<?php echo $id++; ?>>
              <div class='label'><?= $executive['position'] ?></div>
        ...
        <div class='feature-wrapper'><?php
          ...
          foreach ($eb as &$executive) {
            ...
            <div class='feature-display' index='<?= $id++ ?>'>
              <img class='feature-pic' <?= $image ?>>
              <div class='feature-description'>
                <div><?php $member = &$executive['member']; ?>
                  <h1><?= $member['name'] ?></h1>
                  <h2><?= year_level($member['year']).' '.$member['course'] ?></h2>
                  <?= paragraph($executive['description']) ?>
                </div>
              </div>
            </div>
          <?php } unset($eb); ?>
