...
source('dividers.php');
$site = $protocol.$host.absolute_path('/artists.php');
$images = json('artists');
?>
<!DOCTYPE html>
<html>
					...
					<div id='artists-editor' class='editor'>
						...
						<table class='fieldset-table'>
							<tr>
								...
								<td><img id='bands-img' class='img uploadable' src='<?= absolute_path(get($images, 'bands')) ?>'></td>
								<td><img id='soloists-img' class='img uploadable' src='<?= absolute_path(get($images, 'soloists')) ?>'></td>
							</tr>
						</table>
						<div class='save button' disabled>Save Changes</div>
						<div class='reset button' disabled>Reset</div>
