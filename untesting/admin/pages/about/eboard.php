<?php
	...
	$site = $protocol.$host.absolute_path('/about.php#executive-board');
?>
<!DOCTYPE html>
<html>
	<head>
					...
					<fieldset id='eb-info-editor' class='editor fieldset-editor'>
						...
						<div><?php $meta = json('meta'); ?>
							<table class='fieldset-table' cellspacing='10'><tr>
								...
								<td>Group Photo</td>
								<td><img id='eb-group-photo' class='img uploadable' name='image' src='<?php echo absolute_path(get($meta, 'eb group photo')); ?>'><td>
							</tr></table>
						...
						<div class='tree'>
							...
							<div class='node'>
								<div class='legend'>
									...
									<img class='img uploadable' name='image' src='<?php echo absolute_path(get($item, 'image')); ?>'>
